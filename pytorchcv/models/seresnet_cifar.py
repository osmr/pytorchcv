...
def seresnet20_cifar10(num_classes: int = 10,
                       **kwargs) -> nn.Module:
    """
    ...
    nn.Module
        Desired module.
    """
    return get_seresnet_cifar(
        num_classes=num_classes,
        blocks=20,
        bottleneck=False,
        model_name="seresnet20_cifar10",
        **kwargs)


def seresnet20_cifar100(num_classes: int = 100,
                        **kwargs) -> nn.Module:
    """
    ...
    return get_seresnet_cifar(
        ...
        blocks=20,
        bottleneck=False,
        model_name="seresnet20_cifar100",
        **kwargs)


def seresnet20_svhn(num_classes: int = 10,
                    **kwargs) -> nn.Module:
    """
    ...
    return get_seresnet_cifar(
        ...
        blocks=20,
        bottleneck=False,
        model_name="seresnet20_svhn",
        **kwargs)


def seresnet56_cifar10(num_classes: int = 10,
                       **kwargs) -> nn.Module:
    """
    ...
    return get_seresnet_cifar(
        ...
        blocks=56,
        bottleneck=False,
        model_name="seresnet56_cifar10",
        **kwargs)


def seresnet56_cifar100(num_classes: int = 100,
                        **kwargs) -> nn.Module:
    """
    ...
    return get_seresnet_cifar(
        ...
        blocks=56,
        bottleneck=False,
        model_name="seresnet56_cifar100",
        **kwargs)


def seresnet56_svhn(num_classes: int = 10,
                    **kwargs) -> nn.Module:
    """
    ...
    return get_seresnet_cifar(
        ...
        blocks=56,
        bottleneck=False,
        model_name="seresnet56_svhn",
        **kwargs)


def seresnet110_cifar10(num_classes: int = 10,
                        **kwargs) -> nn.Module:
    """
    ...
    return get_seresnet_cifar(
        ...
        blocks=110,
        bottleneck=False,
        model_name="seresnet110_cifar10",
        **kwargs)


def seresnet110_cifar100(num_classes: int = 100,
                         **kwargs) -> nn.Module:
    """
    ...
    return get_seresnet_cifar(
        ...
        blocks=110,
        bottleneck=False,
        model_name="seresnet110_cifar100",
        **kwargs)


def seresnet110_svhn(num_classes: int = 10,
                     **kwargs) -> nn.Module:
    """
    ...
    return get_seresnet_cifar(
        ...
        blocks=110,
        bottleneck=False,
        model_name="seresnet110_svhn",
        **kwargs)


def seresnet164bn_cifar10(num_classes: int = 10,
                          **kwargs) -> nn.Module:
    """
    ...
    return get_seresnet_cifar(
        ...
        blocks=164,
        bottleneck=True,
        model_name="seresnet164bn_cifar10",
        **kwargs)


def seresnet164bn_cifar100(num_classes: int = 100,
                           **kwargs) -> nn.Module:
    """
    ...
    return get_seresnet_cifar(
        ...
        blocks=164,
        bottleneck=True,
        model_name="seresnet164bn_cifar100",
        **kwargs)


def seresnet164bn_svhn(num_classes: int = 10,
                       **kwargs) -> nn.Module:
    """
    ...
    return get_seresnet_cifar(
        ...
        blocks=164,
        bottleneck=True,
        model_name="seresnet164bn_svhn",
        **kwargs)


def seresnet272bn_cifar10(num_classes: int = 10,
                          **kwargs) -> nn.Module:
    """
    ...
    return get_seresnet_cifar(
        ...
        blocks=272,
        bottleneck=True,
        model_name="seresnet272bn_cifar10",
        **kwargs)


def seresnet272bn_cifar100(num_classes: int = 100,
                           **kwargs) -> nn.Module:
    """
    ...
    return get_seresnet_cifar(
        ...
        blocks=272,
        bottleneck=True,
        model_name="seresnet272bn_cifar100",
        **kwargs)


def seresnet272bn_svhn(num_classes: int = 10,
                       **kwargs) -> nn.Module:
    """
    ...
    return get_seresnet_cifar(
        ...
        blocks=272,
        bottleneck=True,
        model_name="seresnet272bn_svhn",
        **kwargs)


def seresnet542bn_cifar10(num_classes: int = 10,
                          **kwargs) -> nn.Module:
    """
    ...
    return get_seresnet_cifar(
        ...
        blocks=542,
        bottleneck=True,
        model_name="seresnet542bn_cifar10",
        **kwargs)


def seresnet542bn_cifar100(num_classes: int = 100,
                           **kwargs) -> nn.Module:
    """
    ...
    return get_seresnet_cifar(
        ...
        blocks=542,
        bottleneck=True,
        model_name="seresnet542bn_cifar100",
        **kwargs)


def seresnet542bn_svhn(num_classes: int = 10,
                       **kwargs) -> nn.Module:
    """
    ...
    return get_seresnet_cifar(
        ...
        blocks=542,
        bottleneck=True,
        model_name="seresnet542bn_svhn",
        **kwargs)


def seresnet1001_cifar10(num_classes: int = 10,
                         **kwargs) -> nn.Module:
    """
    ...
    return get_seresnet_cifar(
        ...
        blocks=1001,
        bottleneck=True,
        model_name="seresnet1001_cifar10",
        **kwargs)


def seresnet1001_cifar100(num_classes: int = 100,
                          **kwargs) -> nn.Module:
    """
    ...
    return get_seresnet_cifar(
        ...
        blocks=1001,
        bottleneck=True,
        model_name="seresnet1001_cifar100",
        **kwargs)


def seresnet1001_svhn(num_classes: int = 10,
                      **kwargs) -> nn.Module:
    """
    ...
    return get_seresnet_cifar(
        ...
        blocks=1001,
        bottleneck=True,
        model_name="seresnet1001_svhn",
        **kwargs)


def seresnet1202_cifar10(num_classes: int = 10,
                         **kwargs) -> nn.Module:
    """
    ...
    return get_seresnet_cifar(
        ...
        blocks=1202,
        bottleneck=False,
        model_name="seresnet1202_cifar10",
        **kwargs)


def seresnet1202_cifar100(num_classes: int = 100,
                          **kwargs) -> nn.Module:
    """
    ...
    return get_seresnet_cifar(
        ...
        blocks=1202,
        bottleneck=False,
        model_name="seresnet1202_cifar100",
        **kwargs)


def seresnet1202_svhn(num_classes: int = 10,
                      **kwargs) -> nn.Module:
    """
